...
# from docx.enum.table import WD_ALIGN_VERTICAL, WD_ALIGN_HORIZONTAL  <-- 오류 유발 라인 제거
# from docx.enum.text import WD_ALIGN_PARAGRAPH  <-- 오류 유발 라인 제거
    ...
    if passage_match:
        ...
        for part in parts:
            ...
            if "📝 문단 요약" in part:
                ...
                # sum_cell.vertical_alignment = 1 # WD_ALIGN_VERTICAL.CENTER 대신 1 사용 (제거된 상수)
