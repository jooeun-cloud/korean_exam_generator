                ...
                if use_summary:
                    if current_d_mode == '직접 입력':
                        ...
                        if current_mode == '단일 지문':
                            ...
                            p_count_info = f"지문은 총 {len(paras)}개의 문단으로 구성되어 있습니다. 각 문단에 맞춰 {len(paras)}개의 요약을 순서대로 작성하시오."
                        else:
                        ...
                        - **[필수 추가]**: 정답 및 해설 섹션의 맨 앞부분에 `<div class="summary-ans-box">` 태그를 사용하여 **[문단별 요약 예시 답안]**을 먼저 작성하시오. 
                        - **[중요]**: {p_count_info} 사용자 입력 지문의 줄바꿈(엔터 두 번)을 기준으로 문단을 나누었으므로 이를 엄격히 따르시오.
                        """
